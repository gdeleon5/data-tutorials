...
## In this section we need to change the value from True to False to upload 
## our own image. Additionally we need to comment out line 105 and add line 106
## to upload the image of Gordon Ramsay.
...
def upload_image():
  ...
  uploaded ="gordon-ramsay.jpg"
  image = imageio.imread(uploaded)
...
## Code to allow users to upload their own image
def main(argv):
  inputfile = ''
  output_file = ''
  helpMessage = """
